...
WFEX v2 adds negotiated versioned records, optional lossless PACKRLE stream compression, private shared-memory slots and optional latest-frame pacing while retaining byte-for-byte v1 compatibility. See the [technical specification](docs/wfex-technical-specification.md), [integration guide](docs/wfex-integration-guide.md), and [compilable producer example](examples/SystemRegisIII.WfexProducerExample/Program.cs).
