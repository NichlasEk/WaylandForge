...
`WAYLANDFORGE_STORMAKT_COPENHAGEN_CODEX_TEST=1` starts directly at the sealed book with fixture writes suppressed. Its complete 620-frame reveal ends at `897e8b53d585ae98` in wide and `d6772a94f01ce21b` in legacy; the wide result is identical through WFEX v1, v2 raw, PACKRLE and shared memory. An isolated schema-8 save resumes at sequence age 246 with the permanent war prompt intact.
