...
3. **World (in progress):** the generated starless Skåne background is packed and frame-verified; three deterministic destructible signal beacons, silhouette-firing mist drones and a red/white fogde convoy are wired with code fallbacks. Transparent foreground props remain.
