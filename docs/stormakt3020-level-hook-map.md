...
3. **World (in progress):** the generated starless Skåne background is packed and frame-verified; three deterministic destructible signal beacons are wired with code fallbacks. Transparent props, fog drones and convoy remain.
