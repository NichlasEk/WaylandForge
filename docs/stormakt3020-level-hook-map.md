...
## Köpenhamn dispatch - checkpoint 10 playable
...
`WAYLANDFORGE_STORMAKT_COPENHAGEN_LANDING_TEST=1` and `WAYLANDFORGE_STORMAKT_COPENHAGEN_GROUND_TEST=1` extend the seven existing Copenhagen fixtures. Complete 760-frame landing traces repeat at `15cca66447daee8a` in wide and `a10ac2aeaf0db652` in legacy. Full shield traces repeat at `5dc660877cedb218` in wide and `6fbd2ddb0ca2f42a` in legacy; full blade traces repeat at `08f4563f5e68f9a6` and `4fac8aaa8cf1fc62`. A 2500-frame blade trace produces `293798c92aa71e59` through WFEX v2 raw, PACKRLE and shared memory. Schema 1/2 remain accepted; an isolated schema-3 save resumes through the submenu inside Rosenborg with blade form, health, position, potion, enemies and partial core health restored.
