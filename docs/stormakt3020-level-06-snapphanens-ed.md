...
8. **Ljud och röster (påbörjad 2026-07-18):** Agnete, Bodil och Dagmar har tre seedlåsta syntetiska referenser och sju färdiga DOTs SOAR-bossrepliker med deterministiskt radiofilter, runtimekoppling och manifest. Unik bana/duell/bossmusik, fasta SFX-seeds, återstående Sören/Ebba/jägarrepliker, lyssningsgodkännande och slutlig mixkontroll återstår. Commit och push.
