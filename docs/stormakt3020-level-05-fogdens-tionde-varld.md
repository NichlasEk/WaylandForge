...
8. **Grafiköversyn (landad 2026-07-16):** det kodritade rälsprovet ersätts av ett packat, kontinuerligt rullande arkivvalv med huvudboksband, kedjor, pergamenttrummor, cyan registerbelysning och vaxsigill. Kedjelås, myntminor, sigillväggar, tullportar, beslagsskåp och Ränteverkets pressar har separata alpha-assets i samma materialfamilj som Rigsregnskabet. Alla sex uppgraderingar har dessutom egna fysiska skeppsdelar, menyikoner och skott- eller energifält: modulerna monteras på rätt nos-, bredside- och akterfäste utan att ändra skeppets träffyta. Kodgrafiken finns kvar som fallback och alla fysiska träffytor är oförändrade.
