...
Status: komplett spelbar bana publicerad som `STRID` 2026-07-16. Beslagfält, tullpass, myntminor, registerval, Ränteverket, tre tvåvalsskåp och Rigsregnskabets trefasfinal kör på eget state och seed `3505`. Bossen har egen packad konst, dansk syntetröst, radiokö och unik 90 BPM-maskinfuga.
...
1. **Plan och kampanjrad (landad 2026-07-16):** detta dokument, Bana 5-rad, nivå-id, seed och separat deterministisk tidslinje.
...
8. **Grafiköversyn (landad 2026-07-16):** det kodritade rälsprovet ersätts av ett packat, kontinuerligt rullande arkivvalv med huvudboksband, kedjor, pergamenttrummor, cyan registerbelysning och vaxsigill. Kedjelås, myntminor, sigillväggar, tullportar, beslagsskåp och Ränteverkets pressar har separata alpha-assets i samma materialfamilj som Rigsregnskabet. Sigillväggarnas verkliga segmenthälsa väljer nu en sammanhållen ny familj med rejäl hel plåt, skadad plåt eller kritiskt spräckt plåt; den gamla tunna röda plankan och orange diagonalen är borta. Ränteverkets återanvända blå skottstreck är ersatta av ett tvåbilders mässings-/cyanprojektil, och pressarnas kvarvarande cyan guide-linjer är borttagna. Tullpassens säkra öppning förannonseras av en kunglig varningsportal, och registervalet har en fysisk tvåvägsväxel med egna Revision- och Kedjehall-emblem i både banan och valpanelen. Alla sex uppgraderingar har dessutom egna fysiska skeppsdelar, menyikoner och skott- eller energifält: modulerna monteras på rätt nos-, bredside- och akterfäste utan att ändra skeppets träffyta. Bossens sista faser använder egna intakta och spräckta huvudboksrullar, sluten och blottad kärna, växlande bärnstens- och cyankraftringar samt en fyrdelad mekanisk dödsexplosion; de gamla diagonalerna och platta cirklarna visas inte när assets finns. Kodgrafiken finns kvar som fallback och alla fysiska träffytor och valgränser är oförändrade.
9. **Ljud och radio (landat 2026-07-16, sanerat 2026-07-21):** inventeringen fann tretton egna Tionde världen-effekter och fem ärvda standardfamiljer: skeppskanon, bredsida/reflektion, deploy-signal, explosion och skrovträff. Alla tretton modellgenererade runtime-klipp är ersatta av korta, deterministiska och helt brusfria procedurljud. Standardkanonen återanvänder Stora Bälts två rena alternerande `piow`, medan bossens fiendeeld har fått en separat mjuk puls. Bredsida, arkivsignal, strukturkrasch och skrovträff har varsin ny nivåfil. Tionde världen har därmed arton egna runtimefiler och använder tjugo rena filer totalt när de två återanvända piow-varianterna räknas separat. Inga generiska stridsljud återstår under aktiv Bana 5-simulering. Kronborrens, Salvdirektörens, Magnetbredsidans och Kedjekarteschens svansar slutar före respektive verkliga omladdning och kan inte staplas till ett kontinuerligt motorsågssurr. De äldre Stable Audio-råfilerna bevaras endast som proveniens; den aktiva generatorn kräver ingen modell, GPU eller spektrumanalys. Sören och Ebbas tre arkivrepliker behåller sina syntetiska rollreferenser och dialogseeds `302122` respektive `302121`. Aktiv radio duckar fortfarande musiken.
10. **Publicering (landad 2026-07-16):** determinism och wide/legacy-spår är stabila, kampanjraden är offentlig `STRID` och utvecklarskölden är borttagen. Beslagspansarets ordinarie engångsladdning är oförändrad. Resultatkortet väntar på Start och återgår sedan till menymusiken med `SNAPPHANENS ED` förvald.
...
- Direkt WFEX startar den offentliga rad 5 och går aldrig via tidigare banors radio- eller fiendetabeller.
...
- Den offentliga `STRID`-raden använder normal livsförlust och invulnerability-tid. Den gamla utvecklarskölden är borttagen; endast Beslagspansarets synliga engångsladdning kan fånga en träff.
- Rigsregnskabet är besegrad genom verklig styrning och eld via den offentliga menyrutten i både 400x280 och 320x224. Efter den fullständiga sigillväggsöversynen och borttagna presslinjer gav upprepade wide-körningar med utvecklarläget avstängt samma slutbildshash `d724b788f2593fc2`; legacy gav `c8a437461e2760ef`. Resultatkortet väntar på dödsradions avslut och visar det sparade kampanjkitet.
- Bana 5:s arton egna runtime-effekter är deterministiska 48 kHz stereo PCM16. Tillsammans med standardkanonens två rena återanvända piow-filer täcker de hela nivåns aktiva ljudyta utan generisk stridsfallback. Ljudmotorns smoke test laddar 104 effekter och 129 radiofiler. Ett nytt 12 500-bilders invincible-spår via den offentliga menyraden och alla tre skåpen når `RIGSREGNSKABET BRUTET` med slutbildshash `0f403d2a17d5129afc7b521890e369f9808346049b97aa9cd88c0d59c14801d8`. De äldre modellråfilerna är bevarade som historisk proveniens bredvid de nya procedurkällorna.
