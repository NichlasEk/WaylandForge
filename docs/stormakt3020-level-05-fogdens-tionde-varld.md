...
8. **Grafiköversyn (landad 2026-07-16):** det kodritade rälsprovet ersätts av ett packat, kontinuerligt rullande arkivvalv med huvudboksband, kedjor, pergamenttrummor, cyan registerbelysning och vaxsigill. Kedjelås, myntminor, sigillväggar, tullportar, beslagsskåp och Ränteverkets pressar har separata alpha-assets i samma materialfamilj som Rigsregnskabet. Kodgrafiken finns kvar som fallback och alla fysiska träffytor är oförändrade.
9. **Publicering:** determinism, wide/legacy, balansering och status `STRID`.
...
- Rigsregnskabet är besegrad genom verklig styrning och eld i både 400x280 och 320x224. Efter grafikpasset gav upprepade wide-körningar genom hela banan samma slutbildshash `ecc0100f1ed0ca57`; legacy gav `7dc210f6e2c5f398`. Resultatkortet väntar på dödsradions avslut och visar det sparade kampanjkitet.
