...
8. **Grafiköversyn (landad 2026-07-16):** det kodritade rälsprovet ersätts av ett packat, kontinuerligt rullande arkivvalv med huvudboksband, kedjor, pergamenttrummor, cyan registerbelysning och vaxsigill. Kedjelås, myntminor, sigillväggar, tullportar, beslagsskåp och Ränteverkets pressar har separata alpha-assets i samma materialfamilj som Rigsregnskabet. Sigillväggarnas verkliga segmenthälsa väljer nu hel, skadad eller kritiskt spräckt plåt; den gamla orange diagonalen är borta. Ränteverkets återanvända blå skottstreck är ersatta av ett tvåbilders mässings-/cyanprojektil. Tullpassens säkra öppning förannonseras av en kunglig varningsportal, och registervalet har en fysisk tvåvägsväxel med egna Revision- och Kedjehall-emblem i både banan och valpanelen. Alla sex uppgraderingar har dessutom egna fysiska skeppsdelar, menyikoner och skott- eller energifält: modulerna monteras på rätt nos-, bredside- och akterfäste utan att ändra skeppets träffyta. Bossens sista faser använder egna intakta och spräckta huvudboksrullar, sluten och blottad kärna, växlande bärnstens- och cyankraftringar samt en fyrdelad mekanisk dödsexplosion; de gamla diagonalerna och platta cirklarna visas inte när assets finns. Kodgrafiken finns kvar som fallback och alla fysiska träffytor och valgränser är oförändrade.
...
10. **Publicering (landad 2026-07-16):** determinism och wide/legacy-spår är stabila, kampanjraden är offentlig `STRID` och utvecklarskölden är borttagen. Beslagspansarets ordinarie engångsladdning är oförändrad.
...
- Rigsregnskabet är besegrad genom verklig styrning och eld via den offentliga menyrutten i både 400x280 och 320x224. Med utvecklarläget avstängt gav upprepade wide-körningar samma slutbildshash `13a6396754662839`; legacy gav `7da732e676686bb3`. Resultatkortet väntar på dödsradions avslut och visar det sparade kampanjkitet.
