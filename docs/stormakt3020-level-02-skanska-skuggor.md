...
Tre fasta Stable Audio 3-klipp ger signalfyrens brott samt Sörens ankomst och reträtt egen identitet. Glimminges varning, järnkorparnas start, järnväggen, kristallspjutets varning, fasbrottet, brandläget och bossdöden är rena procedurtoner och dämpade slag. Bossfamiljen byttes 2026-07-21 efter provspelning: den återkommande järnväggen gick från cirka 3 kHz bredbandsaktivitet till en 137 Hz tonal salva, och ingen modellgenererad brusmatta återstår i bosskampen. Alla runtimefiler är 48 kHz stereo PCM16, tonade i slutet och regenererbara med `tools/stormakt3020/generate_skanska_sfx.py` och fasta seeds `3020201`-`3020216`.
