...
Status: spelbar och publikt startbar kampanjakt för kampanjens sjunde rad, level id `6`. Rymdakten, Holmens landning och markaktens åtta rum genom Sagokonungen, Marginalfogden Korrektorius, Konung Christians vrede och Codexkammaren sitter i en sammanhängande kedja. Developer-submenyn behåller dessutom direktingångar för provning. Den här planen ersätter den tidigare idén att Superarmadans reträtt ensam avslutar kampanjen.
...
**Holmen, Rosenborg, Christiansborg och Codexkammaren - åtta rum:**
...
- vid hjärtat väljer spelaren mellan två författade marginaler: **Hjertat är en port** kompilerar en fysisk passage, medan **Hjertat är öppet** bokstavligen öppnar hjärtat, skadar Karl och återställer försöket utan att skapa en port;
- den korrekta lagen blir kvar som en synlig HUD-marginal och leder till kanongången, där tre nya vakter och en fysisk bredsidekanon måste besegras medan kanonens skjutlinje telegraferas över golvet;
...
- legendvalet följer med genom den öppnade porten som motlegend mot Sagokonungen: den ensamma älgkarolinen stryker varannan kunglig order, medan de sju börjar med högre skada men ger tätare och farligare order;
- Sagokonungen växlar vid verkliga hälsotrösklar mellan en växande kronstämpel, lejonordrar över golvbanor, tre historiskt omöjliga raketer och en sista seglande hästfas; Klingan kan angripa honom och skölden fortsätter upphäva nästa träff;
- Christiansborgs lektor installerar exakt en separat lokal lag utan att skriva över den kvarvarande materiaformen: **Intet danskt verk må flyga** tvingar ned den aktiva pennan, **Silver väger mindre än skuld** gör Karl snabbare och hans hugg tyngre, medan **Kronan äger blott vad den bär** låter varje bruten penna slita hälsa ur fogden;
- Korrektorius fyra roterande fjäderpennor telegraferar **icke**, nationsbytet, den flyttade punkten eller bytet mellan silver och skuld på den verkliga HUD-marginalen; om den markerade pennan inte bryts blir ändringen ett cirkel-, kors-, halvrums- eller trefaldigt viktanfall;
- när alla pennor brutits försvinner fogdens skrivsköld och kroppen blir direkt sårbar; lektorn kan kompilera om lagen under striden och en ny lag ersätter den gamla fullständigt;
- Christians vrede börjar med tre roterande kungliga anspråk; endast motsvarande lokala motlag öppnar rustningen och lektorn kan skriva om lagen utan att lämna striden;
- fas 2 kompilerar Trekroners vertikala lås, Øresunds Øjes kors och Sagokonungens omöjliga raketer som tre separata minneskombinationer;
- fas 3 river **DANSKT**, **SILVER** och **KRONAN** ur marginalen och fäster dem på tre fysiska rustningsdelar med egen hälsa; kroppen förblir låst tills orden har återtagits;
- i slutfasen öppnas silverkretsen och Christian kan endast skadas efter att Karl faktiskt stått kvar i den; rustningen sjunker när den blir tyngre av kungens skuld och segern lämnar en nedfallen kropp i stället för en större explosion;
- efter Christians fall leder den öppna nordporten direkt till en fysisk Codexkammare utan meny; 254 släckta instanskonturer fyller väggarna och boken öppnar sig automatiskt när Karls silverkropp kommer inom läsavstånd;
- sidan avslöjar Karl som instans 255, räknar de 254 misslyckade exekveringarna och stannar på **ÅTERUPPTA KRIGET?**; rörelse och svar är då låsta men pause fungerar fortfarande och den ofullbordade marginalen börjar synas efter slutkortet;
- ett separat schema-8-save i `copenhagen-holmen.json` gör att en vanlig Bana 7-start återupptar rätt markrum med materiaform, legend, lokal lag, pennor, kungligt anspråk, bossminne, stulna ord, silverkretsens ståtid samt Codexens öppningsålder i stället för att spela om Superarmadan;
- developer-läget visar och tillämpar `DEVSKÖLD` på både rymd- och markakten; den nu publikt startbara Bana 7 använder vanlig skada.
- Bana 7 startar hela kedjan direkt från den publika kampanjraden och visar `FORTSÄTT` när marksave finns. Developer-läget öppnar i stället en egen sexradig submeny med direktingångar till ringen, landningen, sparad Holmen, Rosenborg, Marginalvalvet och Codexkammaren.

Miljön, bossarna, landningen, de åtta markrummen, HUD och barriärer har kodritade fallbackformer i wide och legacy. Holmens första grafikpass återanvänder Silverkroppens riktiga Karl-animationer och tempelgolv, men packar egna ankare, kedja, docksmide, arsenalugn, vrakgods, silverhjärta och en full åttaframars Holmen-vakt. Vaktens idle, två gångsteg, telegraph, kontakt, träff, fall och lik följer simulationens verkliga faser; dödsriktningen fryses och kan inte spegelvändas när Karl passerar. Kanongångens vapen återbrukar den befintliga bryggkanonen som ett riktigt stridsobjekt med egen hälsa, varningslinje och vrakbild. Rosenborg återbrukar riktiga tempelport-, altare-, förvridet-silver- och älgkarolin-assets men lägger roterande materiaformer, en 50 procent större legendfigur, minnesekon och djuptelegrafering i separata renderlager. Sagokonungen återbrukar vakt- och älgkarolinfigurer men får en egen stor krona, kunglig mantel, lejon-, raket- och sjölager som följer den verkliga fasen och träffytan. Korrektorius återbrukar den riktiga silverfogden, valvportar och altaret men får fyra stateägda pennor, laglager och textbundna träffytor. Christians vrede återbrukar beslagspansaret och vaktkroppen men bygger en större kunglig silhuett, tre textdelar, minnesgeometri, skuldkedjor och en stateägd silverkrets runt dem. Codexkammarens nya produktionsblad ger boken tre sammanhängande tillstånd, de 254 konturerna en riktig silhuett samt egna valv-, klock-, marginal- och igenkänningslager. Det kungliga bossmotivet tar över från Sagokonungen och en deterministisk 20-sekunders Codexloop bryter slutet ned till silverdrönare och kall halvsekundspuls. Slutbilden avslutas deterministiskt i 400x280 och 320x224 och verifieras genom WFEX v1, v2 raw, PACKRLE och shared memory.
