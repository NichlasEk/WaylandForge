...
Status: spelbar kärnakt för kampanjens sjunde rad, level id `6`. Rymdakten, Holmens landning och markaktens åtta rum genom Sagokonungen, Marginalfogden Korrektorius, Konung Christians vrede och Codexkammaren är developer-startbara. Hela banan förblir låst i publik kampanj tills polish-, balans- och slutmixsvepet är färdigt. Den här planen ersätter den tidigare idén att Superarmadans reträtt ensam avslutar kampanjen.
