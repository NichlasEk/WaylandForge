...
Status: aktiv utvecklingsplan för kampanjens sjunde rad, level id `6`. Rymdakten, Holmens landning och markaktens sju första rum genom Sagokonungen, Marginalfogden Korrektorius och Konung Christians vrede är developer-startbara; hela banan förblir låst i publik kampanj tills Codexkammaren är färdig. Den här planen ersätter den tidigare idén att Superarmadans reträtt ensam avslutar kampanjen.
...
**Holmen, Rosenborg och Christiansborg - första sju rummen:**
...
- ett separat schema-7-save i `copenhagen-holmen.json` gör att en vanlig Bana 7-start återupptar rätt markrum med materiaform, legend, lokal lag, pennor, kungligt anspråk, bossminne, stulna ord och silverkretsens ståtid i stället för att spela om Superarmadan;
