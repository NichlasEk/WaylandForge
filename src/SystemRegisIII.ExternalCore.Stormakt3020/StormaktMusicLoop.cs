...
internal sealed class StormaktMusicLoop : IDisposable
{
    ...
    private static Dictionary<StormaktSound, LoadedEffect> LoadEffects(string soundtrackPath)
    {
        ...
        [
            ...
            (StormaktSound.TitheChainLockBreak, "tithe-chain-lock-break.wav", 0.22f),
            (StormaktSound.TitheCustomsGate, "tithe-customs-gate.wav", 0.18f),
            (StormaktSound.TitheCoinMineCharge, "tithe-coin-mine-charge.wav", 0.24f),
            (StormaktSound.TitheCoinMineBreak, "tithe-coin-mine-break.wav", 0.55f),
            (StormaktSound.TitheRegisterSwitch, "tithe-register-switch.wav", 0.55f),
            (StormaktSound.TitheSealWall, "tithe-seal-wall.wav", 0.18f),
            (StormaktSound.TitheUpgradeInstall, "tithe-upgrade-install.wav", 0.36f),
            (StormaktSound.TitheCrownDrill, "tithe-crown-drill.wav", 0.55f),
            (StormaktSound.TitheVolleyDirector, "tithe-volley-director.wav", 0.06f),
            (StormaktSound.TitheMagnetBroadside, "tithe-magnet-broadside.wav", 0.08f),
            (StormaktSound.TitheChainCanister, "tithe-chain-canister.wav", 0.42f),
            (StormaktSound.TitheBossPhaseBreak, "tithe-boss-phase-break.wav", 0.22f),
            (StormaktSound.TitheLedgerShatter, "tithe-ledger-shatter.wav", 0.20f),
