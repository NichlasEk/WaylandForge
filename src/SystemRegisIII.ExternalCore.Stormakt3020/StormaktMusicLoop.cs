...
internal sealed class StormaktMusicLoop : IDisposable
{
    ...
    public static StormaktMusicLoop? TryStartDefault()
    {
        ...
        foreach (string path in paths)
        {
            ...
            try
            {
                ...
                string snapphaneDescription = File.Exists(snapphanePath)
                    ? $"ready ({snapphaneSamples.Length / Channels / SampleRate}s)" : "combat fallback";
                string redHoundsBossDescription = File.Exists(redHoundsBossPath)
    ...
    private static Dictionary<StormaktSound, LoadedEffect> LoadEffects(string soundtrackPath)
    {
        ...
        [
            ...
            (StormaktSound.StoraBaltPlayerPiowA, "stora-balt-player-piow-a.wav", 0.34f),
            (StormaktSound.StoraBaltPlayerPiowB, "stora-balt-player-piow-b.wav", 0.34f),
            (StormaktSound.StoraBaltEnemyPiow, "stora-balt-enemy-piow.wav", 0.25f),
            (StormaktSound.StoraBaltTurretPiow, "stora-balt-turret-piow.wav", 0.30f),
            (StormaktSound.StoraBaltBridgeCrack, "stora-balt-bridge-crack.wav", 0.42f),
            (StormaktSound.StoraBaltBridgeCollapse, "stora-balt-bridge-collapse.wav", 0.48f),
            (StormaktSound.StoraBaltBossWarning, "stora-balt-boss-warning.wav", 0.34f),
            (StormaktSound.StoraBaltBossSalvo, "stora-balt-boss-salvo.wav", 0.38f),
            (StormaktSound.StoraBaltBossPhaseBreak, "stora-balt-boss-phase-break.wav", 0.48f),
            (StormaktSound.StoraBaltBossDeath, "stora-balt-boss-death.wav", 0.55f),
            (StormaktSound.SkanskaMistPulse, "skanska-mist-pulse.wav", 0.30f),
            (StormaktSound.SkanskaCopperPulse, "skanska-copper-pulse.wav", 0.34f),
            (StormaktSound.SkanskaConvoyPulse, "skanska-convoy-pulse.wav", 0.32f),
            (StormaktSound.SkanskaIronPulse, "skanska-iron-pulse.wav", 0.34f),
            (StormaktSound.SkanskaDrillPulse, "skanska-drill-pulse.wav", 0.36f),
            (StormaktSound.SkanskaEmberPulse, "skanska-ember-pulse.wav", 0.32f),
            (StormaktSound.SkanskaSignalBreak, "skanska-signal-break.wav", 0.40f),
            (StormaktSound.SkanskaSorenArrival, "skanska-soren-arrival.wav", 0.34f),
            (StormaktSound.SkanskaSorenDisengage, "skanska-soren-disengage.wav", 0.42f),
            (StormaktSound.SkanskaGlimmingeWarning, "skanska-glimminge-warning.wav", 0.34f),
            (StormaktSound.SkanskaRavenDeploy, "skanska-raven-deploy.wav", 0.26f),
            (StormaktSound.SkanskaGlimmingeWall, "skanska-glimminge-wall.wav", 0.30f),
            (StormaktSound.SkanskaSpearWarning, "skanska-spear-warning.wav", 0.24f),
            (StormaktSound.SkanskaGlimmingePhaseBreak, "skanska-glimminge-phase-break.wav", 0.38f),
            (StormaktSound.SkanskaGlimmingeBurning, "skanska-glimminge-burning.wav", 0.34f),
            (StormaktSound.SkanskaGlimmingeDeath, "skanska-glimminge-death.wav", 0.44f),
            ...
            (StormaktSound.OresundGuardShot, "oresund-guard-shot.wav", 0.30f),
            (StormaktSound.OresundRailPulse, "oresund-rail-pulse.wav", 0.34f),
            (StormaktSound.OresundFortressPulse, "oresund-fortress-pulse.wav", 0.36f),
            (StormaktSound.OresundCrownPulse, "oresund-crown-pulse.wav", 0.34f),
            (StormaktSound.OresundSorenStrike, "oresund-soren-strike.wav", 0.38f),
            (StormaktSound.OresundSwitchBreak, "oresund-switch-break.wav", 0.42f),
            (StormaktSound.OresundLaserRelay, "oresund-laser-relay.wav", 0.34f),
            (StormaktSound.OresundFlapMotor, "oresund-flap-motor.wav", 0.38f),
            (StormaktSound.OresundTrainCrash, "oresund-train-crash.wav", 0.48f),
            (StormaktSound.OresundCrownCoreBreak, "oresund-crown-core-break.wav", 0.50f),
            (StormaktSound.OresundCrownCoreOpen, "oresund-crown-core-open.wav", 0.42f),
            (StormaktSound.OresundTrainRumble, "oresund-train-rumble.wav", 0.30f),
            (StormaktSound.OresundFortressLock, "oresund-fortress-lock.wav", 0.44f),
            (StormaktSound.OresundCouplingBreak, "oresund-coupling-break.wav", 0.40f),
            (StormaktSound.OresundFortressArrival, "oresund-fortress-arrival.wav", 0.42f),
            (StormaktSound.OresundFortressBreach, "oresund-fortress-breach.wav", 0.38f),
            (StormaktSound.TitheChainLockBreak, "tithe-chain-lock-break.wav", 0.32f),
            (StormaktSound.TitheCustomsGate, "tithe-customs-gate.wav", 0.30f),
            (StormaktSound.TitheCoinMineCharge, "tithe-coin-mine-charge.wav", 0.24f),
            (StormaktSound.TitheCoinMineBreak, "tithe-coin-mine-break.wav", 0.34f),
            (StormaktSound.TitheRegisterSwitch, "tithe-register-switch.wav", 0.34f),
            (StormaktSound.TitheSealWall, "tithe-seal-wall.wav", 0.28f),
            (StormaktSound.TitheUpgradeInstall, "tithe-upgrade-install.wav", 0.34f),
            (StormaktSound.TitheCrownDrill, "tithe-crown-drill.wav", 0.30f),
            (StormaktSound.TitheVolleyDirector, "tithe-volley-director.wav", 0.14f),
            (StormaktSound.TitheMagnetBroadside, "tithe-magnet-broadside.wav", 0.22f),
            (StormaktSound.TitheChainCanister, "tithe-chain-canister.wav", 0.30f),
            (StormaktSound.TitheBossPhaseBreak, "tithe-boss-phase-break.wav", 0.38f),
            (StormaktSound.TitheLedgerShatter, "tithe-ledger-shatter.wav", 0.34f),
            (StormaktSound.TitheStandardBroadside, "tithe-standard-broadside.wav", 0.28f),
            (StormaktSound.TitheArchiveCue, "tithe-archive-cue.wav", 0.28f),
            (StormaktSound.TitheEnemyPulse, "tithe-enemy-pulse.wav", 0.22f),
            (StormaktSound.TitheStructureBreak, "tithe-structure-break.wav", 0.32f),
            (StormaktSound.TitheHullHit, "tithe-hull-hit.wav", 0.34f),
            (StormaktSound.SnapphaneSignalCue, "snapphane-signal-cue.wav", 0.28f),
            (StormaktSound.SnapphaneBeaconBreak, "snapphane-beacon-break.wav", 0.30f),
            (StormaktSound.SnapphaneMineTurn, "snapphane-mine-turn.wav", 0.24f),
            (StormaktSound.SnapphaneMineBurst, "snapphane-mine-burst.wav", 0.30f),
            (StormaktSound.SnapphaneHunterShot, "snapphane-hunter-shot.wav", 0.18f),
            (StormaktSound.SnapphaneHunterBreak, "snapphane-hunter-break.wav", 0.28f),
            (StormaktSound.SnapphaneWreckBreak, "snapphane-wreck-break.wav", 0.30f),
            (StormaktSound.SnapphaneCopperVolley, "snapphane-copper-volley.wav", 0.22f),
            (StormaktSound.SnapphaneChainHook, "snapphane-chain-hook.wav", 0.26f),
            (StormaktSound.SnapphaneRescueRelease, "snapphane-rescue-release.wav", 0.30f),
            (StormaktSound.SnapphaneRedHoundsVolley, "snapphane-red-hounds-volley.wav", 0.24f),
            (StormaktSound.SnapphaneMegaCharge, "snapphane-mega-charge.wav", 0.30f),
            (StormaktSound.SnapphaneChainDeploy, "snapphane-chain-deploy.wav", 0.30f),
            (StormaktSound.SnapphaneChainBreak, "snapphane-chain-break.wav", 0.32f),
            (StormaktSound.SnapphaneFleetBreak, "snapphane-fleet-break.wav", 0.34f),
            (StormaktSound.SnapphaneHullHit, "snapphane-hull-hit.wav", 0.34f),
            (StormaktSound.CopenhagenRingLock, "copenhagen-ring-lock.wav", 0.62f),
            (StormaktSound.CopenhagenClockStrike, "copenhagen-clock-strike.wav", 0.48f),
            (StormaktSound.CopenhagenFrederikChain, "copenhagen-frederik-chain.wav", 0.58f),
            (StormaktSound.CopenhagenLedgerBlade, "copenhagen-ledger-blade.wav", 0.52f),
            (StormaktSound.CopenhagenEyeForecast, "copenhagen-eye-forecast.wav", 0.52f),
            (StormaktSound.CopenhagenCrossCharge, "copenhagen-cross-charge.wav", 0.56f),
            (StormaktSound.CopenhagenShieldWall, "copenhagen-shield-wall.wav", 0.54f),
            (StormaktSound.CopenhagenSuperCompile, "copenhagen-super-compile.wav", 0.56f),
            (StormaktSound.CopenhagenAnchorBreak, "copenhagen-anchor-break.wav", 0.62f),
            (StormaktSound.CopenhagenGroundGate, "copenhagen-ground-gate.wav", 0.56f),
            (StormaktSound.CopenhagenHeartCompile, "copenhagen-heart-compile.wav", 0.58f),
            (StormaktSound.CopenhagenMaterialRewrite, "copenhagen-material-rewrite.wav", 0.48f),
            (StormaktSound.CopenhagenLegendMoose, "copenhagen-legend-moose.wav", 0.62f),
            (StormaktSound.CopenhagenLegendImpact, "copenhagen-legend-impact.wav", 0.42f),
            (StormaktSound.CopenhagenSagaOrder, "copenhagen-saga-order.wav", 0.52f),
            (StormaktSound.CopenhagenSagaHorse, "copenhagen-saga-horse.wav", 0.60f),
            (StormaktSound.CopenhagenPenScratch, "copenhagen-pen-scratch.wav", 0.46f),
            (StormaktSound.CopenhagenEditStamp, "copenhagen-edit-stamp.wav", 0.56f),
            (StormaktSound.CopenhagenWrathClaim, "copenhagen-wrath-claim.wav", 0.58f),
            (StormaktSound.CopenhagenWordReclaim, "copenhagen-word-reclaim.wav", 0.58f),
            (StormaktSound.CopenhagenCircuitOpen, "copenhagen-circuit-open.wav", 0.58f),
            (StormaktSound.CopenhagenRoyalArmorBreak, "copenhagen-royal-armor-break.wav", 0.62f),
            (StormaktSound.CopenhagenCodexRecognize, "copenhagen-codex-recognize.wav", 0.62f),
            (StormaktSound.CopenhagenNavalVolley, "copenhagen-naval-volley.wav", 0.42f),
            (StormaktSound.CopenhagenHullHit, "copenhagen-hull-hit.wav", 0.50f),
            (StormaktSound.CopenhagenStructureBreak, "copenhagen-structure-break.wav", 0.54f),
            (StormaktSound.CopenhagenSignalCue, "copenhagen-signal-cue.wav", 0.46f),
            (StormaktSound.CopenhagenSwordSlash, "copenhagen-sword-slash.wav", 0.44f),
            (StormaktSound.CopenhagenSwordHit, "copenhagen-sword-hit.wav", 0.48f),
            (StormaktSound.CopenhagenSilverWave, "copenhagen-silver-wave.wav", 0.48f),
            (StormaktSound.CopenhagenSilverShatter, "copenhagen-silver-shatter.wav", 0.52f),
        ];
    ...
    private static Dictionary<StormaktVoice, LoadedEffect> LoadVoices(string soundtrackPath)
    {
        ...
        [
            ...
            (StormaktVoice.EbbaVacuumReply, "ebba-silver-vacuum-sv-radio.wav", 0.78f),
            (StormaktVoice.KarlSilverScent, "karl-silver-scent-sv-radio.wav", 0.80f),
            ...
            (StormaktVoice.SorenTitheSeizedShips, "soren-tithe-seized-ships-sv-radio.wav", 0.76f),
            (StormaktVoice.EbbaTithePeaceLoss, "ebba-tithe-peace-loss-sv-radio.wav", 0.80f),
            (StormaktVoice.EbbaTitheSealPress, "ebba-tithe-seal-press-sv-radio.wav", 0.80f),
            ...
            (StormaktVoice.CopenhagenApproach, "copenhagen-approach-sv-radio.wav", 0.84f),
            (StormaktVoice.CopenhagenGate, "copenhagen-gate-sv-radio.wav", 0.92f),
            (StormaktVoice.CopenhagenGateFall, "copenhagen-gate-fall-sv-radio.wav", 0.84f),
            (StormaktVoice.CopenhagenAdmiralty, "copenhagen-admiralty-sv-radio.wav", 0.94f),
            (StormaktVoice.CopenhagenNoon, "copenhagen-noon-sv-radio.wav", 0.84f),
            (StormaktVoice.CopenhagenAdmiraltyFall, "copenhagen-admiralty-fall-sv-radio.wav", 0.86f),
            (StormaktVoice.CopenhagenFrederik, "copenhagen-frederik-da-radio.wav", 0.96f),
            (StormaktVoice.CopenhagenFrederikBlades, "copenhagen-frederik-blades-sv-radio.wav", 0.88f),
            (StormaktVoice.CopenhagenFrederikRepair, "copenhagen-frederik-repair-da-radio.wav", 0.96f),
            (StormaktVoice.CopenhagenFrederikFall, "copenhagen-frederik-fall-da-radio.wav", 0.98f),
            (StormaktVoice.CopenhagenEye, "copenhagen-eye-sv-radio.wav", 0.86f),
            (StormaktVoice.CopenhagenEyeLens, "copenhagen-eye-lens-sv-radio.wav", 0.92f),
            (StormaktVoice.CopenhagenEyeSoren, "copenhagen-eye-soren-sv-radio.wav", 0.88f),
            (StormaktVoice.CopenhagenEyeFall, "copenhagen-eye-fall-sv-radio.wav", 0.86f),
            (StormaktVoice.CopenhagenDannebrog, "copenhagen-dannebrog-da-radio.wav", 0.98f),
            (StormaktVoice.CopenhagenDannebrogGap, "copenhagen-dannebrog-gap-sv-radio.wav", 0.86f),
            (StormaktVoice.CopenhagenDannebrogFall, "copenhagen-dannebrog-fall-sv-radio.wav", 0.90f),
            (StormaktVoice.CopenhagenDuo, "copenhagen-duo-sv-radio.wav", 0.86f),
            (StormaktVoice.CopenhagenAbsalonWall, "copenhagen-absalon-wall-da-radio.wav", 0.96f),
            (StormaktVoice.CopenhagenElefantenCharge, "copenhagen-elefanten-charge-da-radio.wav", 1.00f),
            (StormaktVoice.CopenhagenDuoFall, "copenhagen-duo-fall-da-radio.wav", 0.98f),
            (StormaktVoice.CopenhagenSuper, "copenhagen-super-da-radio.wav", 1.00f),
            (StormaktVoice.CopenhagenSuperCross, "copenhagen-super-cross-sv-radio.wav", 0.88f),
            (StormaktVoice.CopenhagenSuperMemory, "copenhagen-super-memory-da-radio.wav", 1.00f),
            (StormaktVoice.CopenhagenSuperHold, "copenhagen-super-hold-sv-radio.wav", 0.92f),
            (StormaktVoice.CopenhagenSuperFall, "copenhagen-super-fall-da-radio.wav", 1.00f),
            (StormaktVoice.CopenhagenLanding, "copenhagen-landing-sv-radio.wav", 0.88f),
            (StormaktVoice.CopenhagenLandingClear, "copenhagen-landing-clear-sv-radio.wav", 0.92f),
            (StormaktVoice.CopenhagenGround, "copenhagen-ground-sv-radio.wav", 0.86f),
            (StormaktVoice.CopenhagenGroundClear, "copenhagen-ground-clear-sv-radio.wav", 0.90f),
            (StormaktVoice.CopenhagenMarginalFault, "copenhagen-marginal-fault-sv-radio.wav", 0.92f),
            (StormaktVoice.CopenhagenArsenal, "copenhagen-arsenal-sv-radio.wav", 0.88f),
            (StormaktVoice.CopenhagenArsenalClear, "copenhagen-arsenal-clear-sv-radio.wav", 0.90f),
            (StormaktVoice.CopenhagenRosenborg, "copenhagen-rosenborg-sv-radio.wav", 0.88f),
            (StormaktVoice.CopenhagenRosenborgClear, "copenhagen-rosenborg-clear-sv-radio.wav", 0.90f),
            (StormaktVoice.CopenhagenMemoryMachine, "copenhagen-memory-machine-sv-radio.wav", 0.88f),
            (StormaktVoice.CopenhagenLegendCorrupt, "copenhagen-legend-corrupt-sv-radio.wav", 0.94f),
            (StormaktVoice.CopenhagenMemoryClear, "copenhagen-memory-clear-sv-radio.wav", 0.90f),
            (StormaktVoice.CopenhagenSagaKing, "copenhagen-saga-king-sv-radio.wav", 0.98f),
            (StormaktVoice.CopenhagenSagaKingClear, "copenhagen-saga-king-clear-sv-radio.wav", 0.90f),
            (StormaktVoice.CopenhagenKorrektorius, "copenhagen-korrektorius-sv-radio.wav", 0.96f),
            (StormaktVoice.CopenhagenKorrektoriusClear, "copenhagen-korrektorius-clear-sv-radio.wav", 0.92f),
            (StormaktVoice.CopenhagenWrath, "copenhagen-wrath-da-radio.wav", 1.00f),
            (StormaktVoice.CopenhagenWrathClear, "copenhagen-wrath-clear-da-radio.wav", 1.00f),
        ];
        Dictionary<StormaktVoice, LoadedEffect> voices = [];
...
internal enum StormaktSound
{
    ...
    HullHit,
    Deploy,
    StoraBaltPlayerPiowA,
    StoraBaltPlayerPiowB,
    StoraBaltEnemyPiow,
    StoraBaltTurretPiow,
    StoraBaltBridgeCrack,
    StoraBaltBridgeCollapse,
    StoraBaltBossWarning,
    StoraBaltBossSalvo,
    StoraBaltBossPhaseBreak,
    StoraBaltBossDeath,
    SkanskaMistPulse,
    SkanskaCopperPulse,
    SkanskaConvoyPulse,
    ...
    SkanskaSignalBreak,
    SkanskaSorenArrival,
    SkanskaSorenDisengage,
    SkanskaGlimmingeWarning,
    SkanskaRavenDeploy,
    SkanskaGlimmingeWall,
    SkanskaSpearWarning,
    SkanskaGlimmingePhaseBreak,
    SkanskaGlimmingeBurning,
    SkanskaGlimmingeDeath,
    RtsBuild,
    RtsCaroleanVolley,
    RtsMooseCharge,
    RtsTowerFire,
    ...
    OresundTrainRumble,
    OresundFortressLock,
    OresundCouplingBreak,
    OresundFortressArrival,
    OresundFortressBreach,
    TitheChainLockBreak,
    TitheCustomsGate,
    TitheCoinMineCharge,
    TitheCoinMineBreak,
    ...
    TitheCrownDrill,
    TitheVolleyDirector,
    TitheMagnetBroadside,
    TitheChainCanister,
    TitheBossPhaseBreak,
    TitheLedgerShatter,
    TitheStandardBroadside,
    TitheArchiveCue,
    TitheEnemyPulse,
    TitheStructureBreak,
    TitheHullHit,
    SnapphaneSignalCue,
    SnapphaneBeaconBreak,
    SnapphaneMineTurn,
    SnapphaneMineBurst,
    SnapphaneHunterShot,
    SnapphaneHunterBreak,
    SnapphaneWreckBreak,
    SnapphaneCopperVolley,
    SnapphaneChainHook,
    SnapphaneRescueRelease,
    SnapphaneRedHoundsVolley,
    SnapphaneMegaCharge,
    SnapphaneChainDeploy,
    SnapphaneChainBreak,
    SnapphaneFleetBreak,
    SnapphaneHullHit,
    CopenhagenRingLock,
    CopenhagenClockStrike,
    CopenhagenFrederikChain,
    CopenhagenLedgerBlade,
    CopenhagenEyeForecast,
    CopenhagenCrossCharge,
    CopenhagenShieldWall,
    CopenhagenSuperCompile,
    CopenhagenAnchorBreak,
    CopenhagenGroundGate,
    CopenhagenHeartCompile,
    CopenhagenMaterialRewrite,
    CopenhagenLegendMoose,
    CopenhagenLegendImpact,
    CopenhagenSagaOrder,
    CopenhagenSagaHorse,
    CopenhagenPenScratch,
    CopenhagenEditStamp,
    CopenhagenWrathClaim,
    CopenhagenWordReclaim,
    CopenhagenCircuitOpen,
    CopenhagenRoyalArmorBreak,
    CopenhagenCodexRecognize,
    CopenhagenNavalVolley,
    CopenhagenHullHit,
    CopenhagenStructureBreak,
    CopenhagenSignalCue,
    CopenhagenSwordSlash,
    CopenhagenSwordHit,
    CopenhagenSilverWave,
    CopenhagenSilverShatter,
}
...
internal enum StormaktVoice
{
    ...
    CopenhagenAdmiralty,
    CopenhagenNoon,
    CopenhagenAdmiraltyFall,
    CopenhagenFrederik,
    CopenhagenFrederikBlades,
    CopenhagenFrederikRepair,
    CopenhagenFrederikFall,
    CopenhagenEye,
    CopenhagenEyeLens,
    CopenhagenEyeSoren,
    CopenhagenEyeFall,
    CopenhagenDannebrog,
    CopenhagenDannebrogGap,
    CopenhagenDannebrogFall,
    CopenhagenDuo,
    CopenhagenAbsalonWall,
    CopenhagenElefantenCharge,
    CopenhagenDuoFall,
    CopenhagenSuper,
    CopenhagenSuperCross,
    CopenhagenSuperMemory,
    CopenhagenSuperHold,
    CopenhagenSuperFall,
    CopenhagenLanding,
    CopenhagenLandingClear,
    CopenhagenGround,
    CopenhagenGroundClear,
    CopenhagenMarginalFault,
    CopenhagenArsenal,
    CopenhagenArsenalClear,
    CopenhagenRosenborg,
    CopenhagenRosenborgClear,
    CopenhagenMemoryMachine,
    CopenhagenLegendCorrupt,
    CopenhagenMemoryClear,
    CopenhagenSagaKing,
    CopenhagenSagaKingClear,
    CopenhagenKorrektorius,
    CopenhagenKorrektoriusClear,
    CopenhagenWrath,
    CopenhagenWrathClear,
}
