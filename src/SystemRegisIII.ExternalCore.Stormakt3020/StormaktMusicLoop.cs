...
internal sealed class StormaktMusicLoop : IDisposable
{
    ...
    private static Dictionary<StormaktSound, LoadedEffect> LoadEffects(string soundtrackPath)
    {
        ...
        [
            ...
            (StormaktSound.SkanskaGlimmingeWarning, "skanska-glimminge-warning.wav", 0.40f),
            (StormaktSound.SkanskaRavenDeploy, "skanska-raven-deploy.wav", 0.32f),
            (StormaktSound.SkanskaGlimmingeWall, "skanska-glimminge-wall.wav", 0.38f),
            (StormaktSound.SkanskaSpearWarning, "skanska-spear-warning.wav", 0.30f),
            (StormaktSound.SkanskaGlimmingePhaseBreak, "skanska-glimminge-phase-break.wav", 0.46f),
            (StormaktSound.SkanskaGlimmingeBurning, "skanska-glimminge-burning.wav", 0.42f),
            (StormaktSound.SkanskaGlimmingeDeath, "skanska-glimminge-death.wav", 0.52f),
