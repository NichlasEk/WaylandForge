...
internal sealed class StormaktMusicLoop : IDisposable
{
    ...
    private static Dictionary<StormaktSound, LoadedEffect> LoadEffects(string soundtrackPath)
    {
        ...
        [
            ...
            (StormaktSound.CopenhagenRingLock, "copenhagen-ring-lock.wav", 0.50f),
            (StormaktSound.CopenhagenClockStrike, "copenhagen-clock-strike.wav", 0.32f),
            (StormaktSound.CopenhagenFrederikChain, "copenhagen-frederik-chain.wav", 0.42f),
            (StormaktSound.CopenhagenLedgerBlade, "copenhagen-ledger-blade.wav", 0.32f),
            (StormaktSound.CopenhagenEyeForecast, "copenhagen-eye-forecast.wav", 0.36f),
            (StormaktSound.CopenhagenCrossCharge, "copenhagen-cross-charge.wav", 0.42f),
            (StormaktSound.CopenhagenShieldWall, "copenhagen-shield-wall.wav", 0.38f),
            (StormaktSound.CopenhagenSuperCompile, "copenhagen-super-compile.wav", 0.42f),
            (StormaktSound.CopenhagenAnchorBreak, "copenhagen-anchor-break.wav", 0.50f),
            (StormaktSound.CopenhagenGroundGate, "copenhagen-ground-gate.wav", 0.42f),
            (StormaktSound.CopenhagenHeartCompile, "copenhagen-heart-compile.wav", 0.45f),
            (StormaktSound.CopenhagenMaterialRewrite, "copenhagen-material-rewrite.wav", 0.30f),
            (StormaktSound.CopenhagenLegendMoose, "copenhagen-legend-moose.wav", 0.50f),
            (StormaktSound.CopenhagenLegendImpact, "copenhagen-legend-impact.wav", 0.18f),
            (StormaktSound.CopenhagenSagaOrder, "copenhagen-saga-order.wav", 0.36f),
            (StormaktSound.CopenhagenSagaHorse, "copenhagen-saga-horse.wav", 0.46f),
            (StormaktSound.CopenhagenPenScratch, "copenhagen-pen-scratch.wav", 0.28f),
            (StormaktSound.CopenhagenEditStamp, "copenhagen-edit-stamp.wav", 0.42f),
            (StormaktSound.CopenhagenWrathClaim, "copenhagen-wrath-claim.wav", 0.42f),
            (StormaktSound.CopenhagenWordReclaim, "copenhagen-word-reclaim.wav", 0.45f),
            (StormaktSound.CopenhagenCircuitOpen, "copenhagen-circuit-open.wav", 0.45f),
            (StormaktSound.CopenhagenRoyalArmorBreak, "copenhagen-royal-armor-break.wav", 0.48f),
            (StormaktSound.CopenhagenCodexRecognize, "copenhagen-codex-recognize.wav", 0.50f),
        ];
